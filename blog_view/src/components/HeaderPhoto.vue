<template>
  <div class="head-photo" style="width: 100%;height: 800px;">
    <img src="http://116.62.14.32:8080/group1/M00/00/00/rBow6mKPKGiAbV1UAAHSeFYqJKA650.jpg" style="width: 100%;height: 100%"/>
        ...
        <el-col :span="24" style="height: 100%">
          <el-card shadow="none" class="welcome">
            ...
            <div id="waypoint" class="mini-nav" align="center">
              <router-link to="/" class="item el-icon-s-home">
                首页
              </router-link>
              <router-link to="/archives" class="item el-icon-time">
                时间轴
              </router-link>
              <router-link to="/friends" class="item el-icon-edit">
                友人帐
              </router-link>
              <router-link to="/about" class="item el-icon-info">
                关于我
              </router-link>
            </div>
