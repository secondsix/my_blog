<template>
  <div class="index-container" mode="out-in">
    <!-- 顶部导航栏 -->
    <BlogHeaders class="navbar" id="nav" v-show="$route.name !== 'Home' || this.focusMode"></BlogHeaders>
    <HeaderPhoto id="header-photo" :class="{'m-display-none':focusMode}" class="head-photo"
    ...
    <el-backtop style="box-shadow: none;background: none;">
      <img src="../assets/toTopLogo.webp" style="width: 40px; height: 40px"/>
    </el-backtop>
...
<script>
import BlogHeaders from "@/components/BlogHeaders";
...
.index-container {
  ...
  background-image: url("http://116.62.14.32:8080/group1/M00/00/00/rBow6mKPKIuAbAwgAFOXOiR-Pus598.jpg")!important;
